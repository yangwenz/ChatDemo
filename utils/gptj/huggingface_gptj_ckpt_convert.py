...
if __name__ == "__main__":
    ...
    out_path = os.path.join(args.output_dir, f"{model_name}-{args.n_inference_gpus}gpu")
    ...
    try:
        ...
        config["gptj"]["weight_data_type"] = str(get_weight_data_type(hf_config["weight_data_type"]))
